...
const copy = {
  en: {
    ...
    profiles: "Vaults",
    lovedOnes: "Vaults",
    profilesText: "Manage memory vaults and private archives.",
    memories: "Memories",
    ...
    checklistProfiles: "Vault created",
    ...
    featuresProfiles: "Vaults",
    featuresProfilesTitle: "Memory Vaults",
    featuresProfilesText: "Private spaces for family and friend memories.",
  ...
  es: {
    ...
    title: "Boveda de Legado Familiar",
    subtitle: "Preserva recuerdos de voz, videos, fotos, oraciones, historias y momentos familiares aprobados en una boveda privada.",
    create: "Crear boveda",
    record: "Grabar recuerdo",
    invite: "Invitar familia",
    profiles: "Bovedas",
    lovedOnes: "Bovedas",
    profilesText: "Administra bovedas de recuerdos y archivos privados.",
    memories: "Recuerdos",
    ...
    protectedVault: "Boveda protegida",
    privateDefault: "Privada por defecto",
    storageUsed: "Almacenamiento usado",
    storageLimit: "de 50 MB",
    vaultProgress: "Progreso de la boveda",
    checklistConsent: "Consentimiento firmado",
    checklistProfiles: "Boveda creada",
    checklistMemory: "Agregar primer recuerdo",
    checklistPublic: "Activar pagina publica",
    checklistReview: "Revisar grabaciones",
    checklistApprove: "Aprobar para pagina publica",
    promptLabel: "Idea para recordar",
    promptTitle: "Pregunta de hoy",
    promptCta: "Grabar este recuerdo",
    featuresStart: "Empieza aqui",
    featuresConsent: "Consentimiento",
    featuresConsentText: "Administra permisos y autorizaciones familiares.",
    featuresProfiles: "Bovedas",
    featuresProfilesTitle: "Bovedas de recuerdos",
    featuresProfilesText: "Espacios privados para recuerdos de familia y amigos.",
    storageTipGood: "Todavia tienes buen espacio disponible.",
    storageTipMid: "El almacenamiento esta creciendo. Considera subir videos mas cortos.",
    storageTipHigh: "El almacenamiento casi esta lleno. Comprime videos o elimina duplicados.",
    prompts: [
      "Cuenta un recuerdo favorito de tu infancia.",
      "Comparte una receta familiar y quien te la enseno.",
      "Describe una tradicion que quieres que tu familia recuerde.",
      "Graba una bendicion para alguien que amas.",
    ],
  },
};
      ...
      <section className="mobileDashboardHeroGrid">
        <div className="mobileHeroMainCard">
          ...
          <div className="mobileHeroActions">
            ...
            <Link href={user ? "/mobile/connect" : "/mobile/account"}>{t.invite}</Link>
          </div>
