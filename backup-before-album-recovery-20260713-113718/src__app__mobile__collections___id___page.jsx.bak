...
const copy = {
  ...
  es: {
    label: "Ãƒlbum",
    loading: "Cargando Ãƒlbum...",
    notFound: "Ãƒlbum no encontrado",
    notFoundText: "Este Ãƒlbum puede no existir o quizÃƒ no tienes acceso.",
    back: "Volver a Ãƒlbumes",
    edit: "Editar Ãƒlbum",
    uploadMemory: "Subir recuerdo",
    addFromLibrary: "Agregar de biblioteca",
    linkedTo: "Conectado con",
    general: "Ãƒlbum familiar general",
    private: "Privado",
    public: "PÃƒºblico",
    memories: "Recuerdos",
    emptyTitle: "TodavÃƒ­a no hay recuerdos en este Ãƒlbum",
    ...
    removeMemory: "Quitar",
    removeConfirm: "Ã‚Quitar este recuerdo del Ãƒlbum? El recuerdo original permanecerÃƒ en tu biblioteca.",
    removed: "Recuerdo quitado del Ãƒlbum.",
    saved: "Guardado",
    noDescription: "Ãƒlbum privado de recuerdos",
  },
};
